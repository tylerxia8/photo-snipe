...
export const PRACTICE_BOT_PROFILES: Record<PracticeBotDifficulty, PracticeBotProfile> = {
  ...
  medium: {
    ...
    targetPlayerWinRate: 0.5,
    aimErrorDeg: 6,
    reactionDelayMs: [450, 850],
    trackTurnSpeedDegPerSec: 220,
    strafeOnExposureMs: [700, 1100],
    strafeOnExposureChance: 0.75,
    movementSpeedMultiplier: 0.88,
    shootChanceWhenValid: 0.82,
